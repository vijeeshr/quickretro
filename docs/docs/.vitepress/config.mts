...
export default defineConfig({
  ...
  head: [
    ...
    // Meta Tags
    ['meta', { name: 'title', content: 'QuickRetro - Free and Open-Source Sprint Retrospective App' }],
    ['meta', { name: 'robots', content: 'index, follow' }],
    ['meta', { name: 'language', content: 'English' }],
    ['meta', { name: 'keywords', content: 'sprint, agile, restrospective, meeting, websocket, opensource, free' }],
    // OpenGraph tags
    ['meta', { property: 'og:title', content: 'QuickRetro - Free and Open-Source Sprint Retrospective App' }],
