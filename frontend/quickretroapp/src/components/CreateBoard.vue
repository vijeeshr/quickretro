    ...
    <div class="w-full max-w-md">
        <div class="bg-white shadow-md rounded-md p-8">
            ...
            <div class="space-y-6 mt-4">
                <div>
                    <div class="mt-1">
                        <input v-model.trim="boardname" name="name" type="text" placeholder="Type board name here!" required autofocus
                    ...
                    <p v-show="!boardnameEntered" name="name-required" class="text-sm text-red-600 mt-2">Please enter board name</p>
                </div>
                <div>
                    <div class="mt-1">
