export default {
    ...
    common: {
        ...
        customColumnSetup: {
            ...
            shareHelp: 'Copiez le lien ci-dessous pour partager votre configuration de colonnes personnalisée avec d’autres, ou ajoutez-le à vos favoris pour plus tard.',
