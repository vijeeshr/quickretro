export default {
  ...
  dashboard: {
    ...
    share: {
      ...
      shortText: 'Compart',
      qrHelp: 'Qualquer pessoa pode escanear para entrar no quadro diretamente',
      qrAltText: 'Escaneie para entrar neste quadro',
      linkCopied: 'Link do quadro copiado. Compartilhe com outras pessoas!',
    },
    theme: {
      shortText: 'Tema',
    },
