export default {
  ...
  dashboard: {
    ...
    share: {
      ...
      shortText: 'Teilen',
      qrHelp: 'Jeder kann scannen, um direkt dem Board beizutreten',
      qrAltText: 'Scannen, um diesem Board beizutreten',
      linkCopied: 'Board-Link kopiert. Teile ihn mit anderen!',
    },
    theme: {
      shortText: 'Thema',
    },
