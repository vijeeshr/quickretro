export default {
  ...
  dashboard: {
    ...
    share: {
      ...
      qrHelp: 'Любой может отсканировать, чтобы сразу присоединиться к доске',
      qrAltText: 'Отсканируйте, чтобы присоединиться к этой доске',
      linkCopied: 'Ссылка на доску скопирована. Поделитесь ею с другими!',
    },
    theme: {
      shortText: 'Тема',
    },
