export default {
  ...
  dashboard: {
    ...
    share: {
      ...
      shortText: 'Поділит',
      qrHelp: 'Будь-хто може відсканувати, щоб одразу приєднатися до дошки',
      qrAltText: 'Відскануйте, щоб приєднатися до цієї дошки',
      linkCopied: 'Посилання на дошку скопійовано. Поділіться ним з іншими!',
    },
    theme: {
      shortText: 'Тема',
    },
