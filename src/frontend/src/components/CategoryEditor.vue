...
const emit = defineEmits(['category-text-update', 'category-toggle', 'categories-reorder', 'valid'])
...
<template>
  <ul class="space-y-2 text-sm">
    ...
    >
      ...
      <svg
        ...
        stroke-width="2"
        stroke="currentColor"
        class="w-6 h-6 text-gray-900 dark:text-gray-400 cursor-move"
      >
        <path
      ...
      <button v-if="cat.enabled" class="cursor-pointer" @click="toggleCategory(cat.id)">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
      ...
      <button v-else class="cursor-pointer" @click="toggleCategory(cat.id)">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
  ...
  <p
    v-show="!isCategorySelectionValid"
