...
<template>
  <div class="p-2" :class="[`w-full md:px-6 md:pb-6 md:pt-2 md:${width} min-w-0`]">
    <div
      class="grid grid-cols-2 gap-1 mb-2 min-w-0 md:sticky md:z-51 md:bg-gray-100 md:dark:bg-gray-900 md:pb-1"
      ...
      <button
        ...
        :class="{
          'border-sky-400 dark:border-white text-sky-400 hover:text-sky-600 dark:text-white':
            buttonHighlight,
          'border-gray-300 dark:border-white/20 text-gray-600 hover:text-gray-700 dark:text-white':
            !buttonHighlight,
        }"
        @click="$emit('addCard')"
      >
